...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "heptacoin-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.heptacoin.org", ""};
static const string testnet_seeds[] = {"testnet-seed.heptacoin.org", ""};
